...
@Component({
    selector: 'app-add-subtopics',
    templateUrl: './add-subtopics.component.html',
    styleUrls: ['./add-subtopics.component.scss'],
    providers: [MessageService]
})
export class AddSubtopicsComponent implements OnInit {
    topics: any[] = [];
